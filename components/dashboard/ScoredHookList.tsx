      ...
      {hooks.map((hook, i) => (
        <div
          ...
          className={cn(
            ...
            hook.ab_recommended && "border border-blue-500/30"
          )}
        >
          <div className="flex items-start justify-between gap-3">
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-xs bg-muted px-2 py-0.5 rounded capitalize">{hook.type}</span>
              </div>
          ...
          <div className="flex gap-4 text-xs">
            <div>
              ...
              <span className={cn(
                ...
                hook.score >= 80 ? "text-emerald-500" : hook.score >= 60 ? "text-yellow-400" : "text-red-400"
              )}>
                {hook.score}/100
              </span>
            </div>
